...
<head>
    ...
    <style>
        .navbar {
            background-color: #343a40; /* Set navbar color to black */
        }
        .navbar a {
        ...
        <div class="row">
            ...
            while ($data = mysqli_fetch_array($query)) { ?>
                <div class="col-md-3 mt-2">
                                        ...
                                        <div class="m-2">
                                            <div class="overflow-auto">
                                                ...
                                                <div class="sticky-bottom">
                                                    <form id="komentarForm<?php echo $data['fotoid']; ?>" method="POST">
                    ...
                    <script>
                        $("#komentarForm<?php echo $data['fotoid']; ?>").on('submit', function(e) {
                            e.preventDefault(); // Mencegah pengiriman form standar
                            $.ajax({
                                type: 'POST',
                                url: '../config/proses_komentar.php', // URL ke file pemrosesan
                                data: $(this).serialize(), // Mengambil data dari form
                                success: function(response) {
                                    // Memuat ulang komentar setelah berhasil
                                    $("#komentar<?php echo $data['fotoid']; ?> .overflow-auto").load(location.href + " #komentar<?php echo $data['fotoid']; ?> .overflow-auto > *");
                                    $("input[name='isikomentar']").val(''); // Mengosongkan input komentar
                                    // Scroll ke bawah untuk tetap di bagian komentar
                                    const modalBody = $("#komentar<?php echo $data['fotoid']; ?> .overflow-auto");
